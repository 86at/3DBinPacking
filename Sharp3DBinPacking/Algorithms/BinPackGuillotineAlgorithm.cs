...
public class BinPackGuillotineAlgorithm : IBinPackAlgorithm
{
    ...
    {
        foreach (var cuboid in cuboids) Insert(cuboid, _cuboidChoice, _splitMethod);
    }
        ...
        GuillotineSplitHeuristic splitMethod)
    {
        ...
        FindPositionForNewNode(cuboid, cuboidChoice, out var freeNodeIndex);
        ...
        out int freeCuboidIndex)
    {
        ...
        for (var index = 0; index < _freeCuboids.Count; ++index)
        {
